...
/* ALBATOR pour ne plus faire appel ‡ quote.gif 
...
.post ul li {
	display: block;
/* ALBATOR : remplacÈ par un sprite ci-dessous 
	padding-left: 14px;
...
/* ALBATOR ancienne version remplacÈ par sprite:	"background: transparent url(images/ulul.png) no-repeat 0 4px;" 
	NOTE affichage jamais testÈ je ne sais pas ou c'est utilisÈ */    
...
/* ALBATOR : probleme de superposage avec le style .post ul li:before -> commentÈ car avoir une image encore diffÈrente n'apporte pas tant de chose (ul.png / ulul.png)
	display: inline;
	content:"";
	background: transparent url(images/sprite3.png) no-repeat -41px -41px;
    width: 6px;
...
/*	color: #e2d6ad;  plouf*/
	color: maroon;
    /* ALBATOR ancienne version : -- SOUCI car retour ‡ la ligne du texte affiche l'image du dessous 
...
/*ALBATOR style pour le sprite ‡ la place de "background: transparent url(images/fleche.png) no-repeat 0 0.25em" */
#blognav li:before {    
	display: inline-block;
    content: "";
    width: 10px;
